# Git Lab Assignment --Finished!! [![Build
Status](https://travis-ci.org/slackboxster/git-lab-assignment.svg?branch=master)](https://travis-ci.org/slackboxster/git-lab-assignment)
...
App](https://github.com/churchconnect/mobile-app).

Create a fork of the repository in your own github account, and follow the
instructions below.
